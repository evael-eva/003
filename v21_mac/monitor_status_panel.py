...
# === macOS 适配: 平台字体检测 ===
import sys as _sys
def _get_system_font_ms(size=-1, bold=False):
    """获取跨平台系统中文字体"""
    from PyQt5.QtGui import QFont
    family = "PingFang SC" if _sys.platform == 'darwin' else "Microsoft YaHei"
...
class MonitorStatusPanel(QWidget):
    ...
    def _init_ui(self):
        ...
        title_label.setFont(_get_system_font_ms(14, bold=True))
